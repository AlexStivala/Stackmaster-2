...
namespace LogicLayer.Collections
{
    ...
    public class RaceDataCollection
    {
        ...
        public BindingList<RaceDataModel> GetRaceDataCollectionCounty(string electionMode, Int16 stateNumber, string raceOffice, Int16 cd, string electionType, Int16 candidatesToReturn,
            bool candidateSelectEnable, int candidateId1, int candidateId2, int candidateId3, int candidateId4)
        {
            DataTable dataTable;
            ...
            try
            {
                ...
                if (stateNumber != -1)
                {
                    dataTable = raceDataAccess.GetRaceDataCounty(electionMode, stateNumber, raceOffice, cd, electionType, candidateSelectEnable, candidateId1, candidateId2, candidateId3, candidateId4);
