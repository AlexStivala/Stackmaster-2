...
namespace DataInterface.DataAccess
{
    ...
    public class ExitPollAccess
    {
        ...
        /// </summary>
        public DataTable GetExitPollQuestions(Boolean manual)
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(ElectionsDBConnectionString))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand())
                    {
                        ...
                        {
                            if (manual == true)
                                cmd.CommandText = SQLCommands.sqlGetManualExitPollQuestions;
                            else 
                                cmd.CommandText = SQLCommands.sqlGetExitPollQuestions;
